...
//EL CONTENEDOR ES DE UNA CARD DE BOOTSTRAP SOLO REMPLACE POR LAS CONSTANTES PARA LA INFO
stockProductos.forEach((prod) => {
  const { id, nombre, precio, desc, img, cantidad } = prod;
  //SE DEBE CONER UN + PARA QUE QUE ENTRE MÁS PRODUCTOS
  if (contenedor) {
...
function guardarStorage() {
  localStorage.setItem("carrito", JSON.stringify(carrito)); //JavaScript value to a JSON string,
}
